...
import com.kubling.core.types.InputStreamFactory;
import com.kubling.core.types.InputStreamFactory.StreamFactoryReference;
import com.kubling.core.util.AccessibleBufferedInputStream;
...
public class ObjectDecoderInputStream extends ObjectInputStream {
    ...
    public ObjectDecoderInputStream(AccessibleBufferedInputStream in, ClassLoader classLoader, int maxObjectSize) 
