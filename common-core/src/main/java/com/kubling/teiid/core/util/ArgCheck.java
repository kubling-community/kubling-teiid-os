...
public class ArgCheck {
    ...
    public static void isNonNegative(int value, String message) {
        if (value < 0) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isNonNegativeInt");
    ...
    public static void isNonPositive(int value, String message) {
        if (value > 0) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isNonPositiveInt");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNegative(int value, String message) {
        if (value >= 0) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isNegativeInt");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isPositive(int value, String message) {
        if (value <= 0) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isPositiveInt");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNotNull(Object value, String message) {
        if (value == null) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isNonNull");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNull(Object value, String message) {
        if (value != null) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isNull");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isInstanceOf(Class theClass, Object value, String message) {
        ...
        if (!theClass.isInstance(value)) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isInstanceOf", theClass.getName(), value.getClass().getName());
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNotEmpty(Collection collection, String message) {
        ...
        if (collection.isEmpty()) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isCollectionNotEmpty");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNotEmpty(Map map, String message) {
        ...
        if (map.isEmpty()) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isMapNotEmpty");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void isNotEmpty(Object[] array, String message) {
        ...
        if (array.length == 0) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.isArrayNotEmpty");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void contains(Collection collection, Object value, String message) {
        ...
        if (!collection.contains(value)) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.contains");
            throw new IllegalArgumentException(msg);
        }
    }
    ...
    public static void containsKey(Map map, Object key, String message) {
        ...
        if (!map.containsKey(key)) {
            final String msg = message != null ?
                    message :
                    CorePlugin.Util.getString("ArgCheck.containsKey");
            throw new IllegalArgumentException(msg);
        }
    }
