...
public final class PropertiesUtils {
    ...
    public static class InvalidPropertyException extends TeiidRuntimeException {
        ...
        public InvalidPropertyException(
                BundleUtil.Event event,
                String propertyName,
                Object value, Class<?> expectedType,
                Throwable cause) {
            super(event, cause,
                    CorePlugin.Util.getString(
                            "InvalidPropertyException.message", propertyName, value, expectedType.getSimpleName()));
        }
    ...
    static String getValue(String key, Map sysProps,
        ...
        if (val instanceof String) {
            ...
            if (stringVal == null) {
                ...
                newKey = newKey.replaceAll("([A-Z]|[a-z]+)([A-Z])", "$1_$2");
                newKey = newKey.replaceAll("([A-Z]|[a-z]+)([A-Z])", "$1_$2");
