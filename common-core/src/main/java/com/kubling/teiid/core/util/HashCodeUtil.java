...
public final class HashCodeUtil {
    ...
    public static int hashCode(int previous, boolean x) {
        return (PRIME * previous) + (x ? 1 : 0);
    }

    public static int hashCode(int previous, int x) {
        return (PRIME * previous) + x;
    }

    public static int hashCode(int previous, long x) {
        // convert to two ints
        return (PRIME * previous) +
                (int) (PRIME * (x >>> 32) + (x & 0xFFFFFFFFL));
    }

    public static int hashCode(int previous, float x) {
        return hashCode(previous, (x == 0.0F) ? 0 : Float.floatToIntBits(x));
    }

    public static int hashCode(int previous, double x) {
        // convert to long
        return hashCode(previous, (x == 0.0) ? 0L : Double.doubleToLongBits(x));
    }

    public static int hashCode(int previous, Object... x) {
        if (x == null) {
            return PRIME * previous;
        }
        int hc = previous;
        for (Object o : x) {
            hc = (o == null) ? (PRIME * hc) : (PRIME * hc) + o.hashCode();
        }
        return hc;
    }
     ...
     */
    public static int expHashCode(int previous, Object[] x) {
        if (x == null) {
            return PRIME * previous;
        }
     ...
     * for good time complexity.
     */
    public static int expHashCode(int previous, Collection<?> x) {
        if (x == null || x.isEmpty()) {
            return PRIME * previous;
        }
    ...
    public static int expHashCode(CharSequence x) {
        return expHashCode(x, true);
    }

    public static int expHashCode(CharSequence x, boolean caseSensitive) {
        if (x == null) {
            return 0;
        }
        int hc = x.length();
