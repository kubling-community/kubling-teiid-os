...
package com.kubling.core.types.basic;

import com.kubling.core.CorePlugin;
import com.kubling.core.types.ArrayImpl;
import com.kubling.core.types.DataTypeManager;
import com.kubling.core.types.Transform;
import com.kubling.core.types.TransformationException;
            ...
            if (targetType.isArray()) {
                ...
                if (value.getClass().isArray()) {
                    if (value.getClass().getComponentType().isPrimitive()
                            && targetType.getComponentType().isAssignableFrom(
                            convertPrimitiveToObject(value.getClass().getComponentType()))) {
                        Object[] result = (Object[]) java.lang.reflect.Array
                                .newInstance(targetType.getComponentType(), java.lang.reflect.Array.getLength(value));
                    ...
                    Object[] result = (Object[]) java.lang.reflect.Array
                            .newInstance(targetComponentType, java.lang.reflect.Array.getLength(value));
