...
public class TestDataTypeManager {
    ...
    private void helpDetermineDataType(Object value, Class<?> expectedClass) {
        ...
        assertEquals(expectedClass, actualClass, "Mismatch in expected and actual MetaMatrix type class for [" + value + "]: "); //$NON-NLS-1$ //$NON-NLS-2$
    }
    ...
    @Test public void testTypeMappings() {
        ...
        for (String dataTypeName : dataTypeNames) {
            ...
            assertNotNull(dataTypeClass, "Data type class was null for type " + dataTypeName); //$NON-NLS-1$
            String dataTypeName2 = DataTypeManager.getDataTypeName(dataTypeClass);
            assertEquals(dataTypeName, dataTypeName2); //$NON-NLS-1$
        }
    }
    ...
    @Test public void testJDBCSQLTypeInfo() {
        ...
        for (String type : types) {
            assertEquals(
                    ...
                    "Didn't get match for "+ type); //$NON-NLS-1$
    ...
    @Test public void testStringToXML() throws Exception {
